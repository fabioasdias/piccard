...
existing data clustering methods,\revision{2.1}{ geographic constraints and
...
\revision{1.3}{using pre-harmonised data from the Longitudinal Tract Data
Base~\citep{Logan2014} or the Neighborhood Change Database~\citep{ncdb}, albeit
...
potentially increased spatial\revision{1.4}{ precision}, this approach does not
...
\revision{2.1}{In geography, this problem is known as
...
\revision{1.5/2.2}{Since we adopted a network-based data representation and our objectives include
