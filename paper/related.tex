...
existing data clustering methods,\revision{ geographic constraints and
...
distance metric is between the nodes is associated with the edges. We adopted a
distance based on the data associated with each node. The algorithm merges
clusters based on these distances, creating an hierarchy instead of a fixed
