...
\begin{abstract}
  \revision{This paper proposes a novel method for data-driven identification of
	...
	need for geographical harmonisation}. Our proposal removes the technical
	limitations that required the creation of artificial data points that is
	currently used in virtually all longitudinal analysis of evolving region-based
	data.
  ...
  both experts and non-experts to characterize broad patterns of stability and
