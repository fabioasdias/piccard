...
adequate, if a study is focused on a small subregion, fixed in time, limiting
and modifying the data to fit that specific region of interest sounds not only
reasonable, but recommended, albeit the creation of artificial data points.
However, that is a simplistic view that ignores interactions beyond those
